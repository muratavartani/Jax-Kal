#include <OpenGL/glew.h> // Include BEFORE GUI.h
...
CEGUI::OpenGL3Renderer* ContinuumEngine2D::GUI::m_renderer = nullptr;

void ContinuumEngine2D::GUI::init(const std::string& resourceDirectory) {
...
void ContinuumEngine2D::GUI::destroy() {
...
void ContinuumEngine2D::GUI::draw() {
...
void ContinuumEngine2D::GUI::update() {
...
void ContinuumEngine2D::GUI::setMouseCursor(const std::string& imageFile) {
	m_context->getMouseCursor().setDefaultImage(imageFile);
}

void ContinuumEngine2D::GUI::showMouseCursor() {
	m_context->getMouseCursor().show();
}

void ContinuumEngine2D::GUI::hideMouseCursor() {
...
void ContinuumEngine2D::GUI::onSDLEvent(SDL_Event& evnt) {
...
void ContinuumEngine2D::GUI::loadScheme(const std::string& schemeFile) {
	CEGUI::SchemeManager::getSingleton().createFromFile(schemeFile);
}

CEGUI::Window* ContinuumEngine2D::GUI::createWidget(const std::string& type, const glm::vec4& destRectPerc, const glm::vec4& destRectPix, const std::string& name /*= ""*/) {
...
CEGUI::Window* ContinuumEngine2D::GUI::createWidget(CEGUI::Window* parent, const std::string& type, const glm::vec4& destRectPerc, const glm::vec4& destRectPix, const std::string& name /*= ""*/) {
	CEGUI::Window* newWindow = CEGUI::WindowManager::getSingleton().createWindow(type, name);
...
void ContinuumEngine2D::GUI::setWidgetDestRect(CEGUI::Window* widget, const glm::vec4& destRectPerc, const glm::vec4& destRectPix) {
...
void ContinuumEngine2D::GUI::setFont(const std::string& fontFile) {
