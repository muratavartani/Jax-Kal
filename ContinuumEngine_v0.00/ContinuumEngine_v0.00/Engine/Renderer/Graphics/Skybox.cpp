...
void Skybox::Initialize() {
	...
	glUniform1i(glGetUniformLocation(ShaderHandler::GetInstance()->GetShader("SkyboxShader"), "skybox"), 0);
}
...
void Skybox::Render(Camera* camera_) {
	...
	glUniformMatrix4fv(glGetUniformLocation(ShaderHandler::GetInstance()->GetShader("SkyboxShader"), "view"), 1, GL_FALSE, glm::value_ptr(glm::mat4(glm::mat3(camera_->GetView()))));
