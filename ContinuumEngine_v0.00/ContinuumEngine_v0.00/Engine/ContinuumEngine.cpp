...
bool ContinuumEngine::Initialize(std::string name_, int width_, int height_) {
	...
	//"frameShader"
	ShaderHandler::GetInstance()->CreateProgram("frameShader", "Engine/Renderer/Graphics/Shaders/FrameVertexShader.glsl", "Engine/Renderer/Graphics/Shaders/FrameFragmentShader.glsl");
	...
	glUniform1i(glGetUniformLocation(ShaderHandler::GetInstance()->GetShader("frameShader"), "scene"), 0);
	...
	glUniform1i(glGetUniformLocation(ShaderHandler::GetInstance()->GetShader("bloomFinalShader"), "skybox"), 2);
